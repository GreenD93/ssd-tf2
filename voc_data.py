...
class VOCDataset():
    ...
    def _get_annotation(self, index, orig_shape):
        ...
        Returns:
            ex) if object is 2, then
            boxes: numpy array of shape (num_gt, 4) -> tf.Tensor: shape=(2, 4)
            labels: numpy array of shape (num_gt,) -> array([label1,label2])
        """
        ...
        # 이미지의 object가 2개있으면 -> boxes, labels (3000,2)
        for obj in objects:
